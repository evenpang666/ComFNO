...
class SPNO2d(nn.Module):
    def __init__(self, modes1, modes2, width1,width2, eps, x_grid_dim, y_grid_dim, x_begin=0, x_end=1, y_begin=0, y_end=1):
        ...
        self.f1 = nn.Linear(self.y_grid_dim, 128)
        self.f2 = nn.Linear(128, 1)
        self.f3 = nn.Linear(self.x_grid_dim, 128)
